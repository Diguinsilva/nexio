    ...
    <div className="p-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        ...
        <button
          ...
          className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-medium transition-colors"
        >
          <Plus size={20} />
          Novo Banner
        </button>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                type="submit"
                disabled={saving}
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-medium disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
              >
                <Save size={20} />
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded-lg font-medium transition-colors"
              >
                Cancelar
              </button>
            </div>
                ...
                <div className="p-6 md:w-2/3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-1 px-3 py-2.5 sm:py-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm transition-colors"
                    >
                      <Edit2 size={14} />
                      Editar
                    </button>
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-1 px-3 py-2.5 sm:py-1.5 bg-gray-500 hover:bg-gray-600 text-white rounded-lg text-sm transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-1 px-3 py-2.5 sm:py-1.5 bg-red-500 hover:bg-red-600 text-white rounded-lg text-sm transition-colors"
                    >
                      <Trash2 size={14} />
                      Deletar
                    </button>
